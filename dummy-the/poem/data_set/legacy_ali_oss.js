...
var LegacyOSS = function(_host, _port, _accessKey, _accessSecret) {
    this.option = {
...
LegacyOSS.prototype.saveObjectFromBinary = function(objectID, bufferContent, bucketName, contentType, callback) {
...
LegacyOSS.prototype.getObjectByID = function(objectID, bucketName, callback) {
...
LegacyOSS.prototype.serveObjectByID = function(objectID, bucketName, res, callback) {
...
LegacyOSS.prototype.listObjects = function(from, count, bucketName, callback) {
    this.ossClient.listObject({
        bucket: bucketName,
        prefix: '',
        marker: from,
